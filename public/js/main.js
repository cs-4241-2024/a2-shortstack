...
const addBookToTable = function( book, table ) {
  ...
  deleteButton.innerHTML = '<a class="delete-img-wrapper" onclick="deleteBook(this)"><img src="images/delete.svg" alt="Delete Book"></a>';
  ...
  if (book.status === "read") {
    ...
    picker.addEventListener("change", function( event ) {
      console.log("Updated " + book["book-id"] + " to " + event.target.value);
      updateBook(book["book-id"], "status", event.target.value);
    });
...
const updateTable = function( books) {
